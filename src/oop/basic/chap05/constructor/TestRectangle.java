...
public class TestRectangle {
	public static void main(String s[]){
		...
		String biggerArea = rec1.biggerArea(rec2);	
		if(biggerArea == "equal") {
			System.out.println("넓이는 같습니다");
		}
		else {
			System.out.println("넓이는 " + biggerArea+ "직사각형이 더 큽니다.");
		}
		// TODO 2) 두 직사각형의 둘레를 비교하십시오.
		String biggerPerimeter = rec1.biggerPerimeter(rec2);
		if(biggerPerimeter == "equal") {
			System.out.println("둘레는 같습니다");
		}
		else {
			System.out.println("둘레" + biggerPerimeter+ "직사각형이 더 큽니다.");
		}
	}
}
